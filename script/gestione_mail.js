...
function submitContactForm(subject) {
    ...
    for (var pair of formData.entries()) {
        ...
        switch (pair[0]) {
            case "message": MailData.message = pair[1]; break;
            case "name": MailData.name = "Cordiali Saluti, %0A" + pair[1]; break;
            case "phone": MailData.phone = "Può contattattarmi al : " + pair[1]; break;
            case "email": MailData.mittente = pair[1]; break;
        }
    }
