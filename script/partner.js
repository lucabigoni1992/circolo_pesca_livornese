...
function cleanAllRow(region) {
    while (region.firstChild) region.removeChild(region.firstChild); //levo tutti i figli per degli elementi passati
}
//logiche
...
function alreadyTaken(dictionary, key) {
    for ( var Dicix = 0; Dicix < dictionary.length; Dicix++)
